  ...
  return(
    <footer className={`duration-500 fixed bg-opacity-50 backdrop-blur-sm
     ...
     ${darkmode ? 'text-white bg-gray-800' : 'text-gray-900 bg-white'}`}>
      Copyright 2022 @ All rights reserved <Link href="https://www.linkedin.com/in/francoborgiani/"><a><span className={`${darkmode? 'text-blue-300' : 'text-purple-600'}`}>Franco Borgiani</span></a></Link>
    </footer>
  )
}
